...
In all cases the `total_pages` estimate seems to be better than the `quick_pages`, with the exception of `bk0000869`, where either hyphens have been used improperly in the `pages` field, or the `quick_pages` is significantly off.
