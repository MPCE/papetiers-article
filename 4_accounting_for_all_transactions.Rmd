...
In nearly all cases the `total_pages` estimate seems to be better than the `quick_pages`, with the exception of examples like `bk0001505` and `bk0004313` where hyphens have been used incorrectly in the 'pages' field. I have not corrected these few errors yet, but I will do so in the underlying database when I get the chance.
